package com.gateway.core.filter.security;

import com.gateway.common.utils.cipher.RSAUtil;
	...
	public void doFilter(GatewayContext ctx) throws Exception {
		...
		if (encryptSymmetricKey != null) {
			try {
				...
				if (!jedis.addScoreSet(securityKey, symmetricKey, (int) (System.currentTimeMillis() + SYMMETRIC_KEY_EXPIRE_TIME))) {
